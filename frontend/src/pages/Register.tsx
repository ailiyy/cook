...
export default function Register() {
  ...
  return (
    <div className="max-w-sm mx-auto mt-24">
      <h1 className="text-2xl font-semibold text-warm-900 tracking-tight mb-2 text-center">注册</h1>
      <p className="text-warm-400 text-sm text-center mb-8">创建一个新账号</p>
      {error && (
      ...
      <form onSubmit={handleSubmit} className="bg-white rounded-2xl border border-warm-200 p-6">
        ...
        <div className="mb-6">
          <label className="block text-sm font-medium text-warm-700 mb-2">确认密码</label>
          <input
            type="password"
            value={confirm}
